...
class ViewController: UIViewController {
    ...
    private func layoutGreenView() {
        NSLayoutConstraint.activate(
            [
                ...
                greenView.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 16),
                greenView.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -16),
    ...
    private func layoutRedView() {
        NSLayoutConstraint.activate(
            [
                redView.topAnchor.constraint(equalTo: greenView.bottomAnchor, constant: 24),
                redView.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 16),
                redView.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -16),
